# The origin is ninja-scan-light/tool/swig/spec/SylphideMath_spec.rb

require 'gps_pvt/SylphideMath'
require 'matrix'

require 'rspec'

RSpec::shared_examples 'Matrix' do
  let!(:tolerance){GPS_PVT::SylphideMath::tolerance}
  after{GPS_PVT::SylphideMath::tolerance = tolerance}
  let(:params){{
    :rc => [8, 8],
    :acceptable_delta => 1E-8,
  }}
...
RSpec::describe GPS_PVT::SylphideMath::MatrixD do
  let(:mat_type){GPS_PVT::SylphideMath::MatrixD}
...
RSpec::describe GPS_PVT::SylphideMath::MatrixComplexD do
  let(:mat_type){GPS_PVT::SylphideMath::MatrixComplexD}
