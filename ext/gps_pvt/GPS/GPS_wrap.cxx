...
#define SWIGTYPE_p_GPS_SolverT_double_t swig_types[7]
#define SWIGTYPE_p_GPS_SpaceNodeT_double_t swig_types[8]
#define SWIGTYPE_p_GPS_SpaceNodeT_double_t__Ionospheric_UTC_Parameters swig_types[9]
#define SWIGTYPE_p_GPS_SpaceNodeT_double_t__SatelliteProperties__Ephemeris swig_types[10]
#define SWIGTYPE_p_GPS_TimeT_double_t swig_types[11]
#define SWIGTYPE_p_GPS_TimeT_double_t__leap_second_event_t swig_types[12]
#define SWIGTYPE_p_GPS_TimeT_double_t__leap_year_prop_res_t swig_types[13]
#define SWIGTYPE_p_GPS_User_PVTT_double_t swig_types[14]
#define SWIGTYPE_p_MatrixT_ComplexT_double_t_Array2D_DenseT_ComplexT_double_t_t_MatrixViewBaseT_t_t swig_types[15]
#define SWIGTYPE_p_MatrixT_double_Array2D_DenseT_double_t_MatrixViewBaseT_t_t swig_types[16]
#define SWIGTYPE_p_MatrixViewBaseT_t swig_types[17]
#define SWIGTYPE_p_MatrixViewFilterT_MatrixViewBaseT_t_t swig_types[18]
#define SWIGTYPE_p_Matrix_FrozenT_double_Array2D_DenseT_double_t_MatrixViewBaseT_t_t swig_types[19]
#define SWIGTYPE_p_RINEX_ObservationT_double_t swig_types[20]
#define SWIGTYPE_p_System_ENUT_double_WGS84_t swig_types[21]
#define SWIGTYPE_p_System_LLHT_double_WGS84_t swig_types[22]
#define SWIGTYPE_p_System_XYZT_double_WGS84_t swig_types[23]
#define SWIGTYPE_p_char swig_types[24]
#define SWIGTYPE_p_double swig_types[25]
#define SWIGTYPE_p_enu_t swig_types[26]
#define SWIGTYPE_p_float_t swig_types[27]
#define SWIGTYPE_p_gps_time_t swig_types[28]
#define SWIGTYPE_p_int swig_types[29]
#define SWIGTYPE_p_int_t swig_types[30]
#define SWIGTYPE_p_llh_t swig_types[31]
#define SWIGTYPE_p_p_GPS_Solver_RAIM_LSRT_double_GPS_Solver_Base_DebugT_double_GPS_Solver_BaseT_double_t_t_t__user_pvt_t__detection_t swig_types[32]
#define SWIGTYPE_p_p_GPS_Solver_RAIM_LSRT_double_GPS_Solver_Base_DebugT_double_GPS_Solver_BaseT_double_t_t_t__user_pvt_t__exclusion_t swig_types[33]
#define SWIGTYPE_p_s16_t swig_types[34]
#define SWIGTYPE_p_s32_t swig_types[35]
#define SWIGTYPE_p_s8_t swig_types[36]
#define SWIGTYPE_p_satellites_t swig_types[37]
#define SWIGTYPE_p_self_t swig_types[38]
#define SWIGTYPE_p_std__vectorT_int_t swig_types[39]
#define SWIGTYPE_p_swig__GC_VALUE swig_types[40]
#define SWIGTYPE_p_u16_t swig_types[41]
#define SWIGTYPE_p_u32_t swig_types[42]
#define SWIGTYPE_p_u8_t swig_types[43]
#define SWIGTYPE_p_uint_t swig_types[44]
#define SWIGTYPE_p_unsigned_int swig_types[45]
#define SWIGTYPE_p_xyz_t swig_types[46]
...
SWIGINTERN int GPS_SpaceNode_Sl_double_Sg__read(GPS_SpaceNode< double > *self,char const *fname){
    ...
    return RINEX_NAV_Reader<double>::read_all(fin, *self);
  }
...
SWIGINTERN void GPS_Ephemeris_Sl_double_Sg__parse(GPS_Ephemeris< double > *self,unsigned int const *buf,int *subframe_no,int *iodc_or_iode){
...
SWIGINTERN double GPS_SolverOptions_Sl_double_Sg__set_elevation_mask(GPS_SolverOptions< double > *self,double const &v){
  return self->elevation_mask = v;
}
SWIGINTERN double const &GPS_SolverOptions_Sl_double_Sg__get_elevation_mask(GPS_SolverOptions< double > const *self){
  return self->elevation_mask;
}
SWIGINTERN double GPS_SolverOptions_Sl_double_Sg__set_residual_mask(GPS_SolverOptions< double > *self,double const &v){
  return self->residual_mask = v;
}
SWIGINTERN double const &GPS_SolverOptions_Sl_double_Sg__get_residual_mask(GPS_SolverOptions< double > const *self){
  return self->residual_mask;
}
SWIGINTERN double GPS_SolverOptions_Sl_double_Sg__set_f_10_7(GPS_SolverOptions< double > *self,double const &v){
  return self->f_10_7 = v;
}
SWIGINTERN double const &GPS_SolverOptions_Sl_double_Sg__get_f_10_7(GPS_SolverOptions< double > const *self){
  return self->f_10_7;
}
...
_wrap_Ionospheric_UTC_Parameters_alphae___(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< GPS_Ionospheric_UTC_Parameters< double > * >(argp1);
  {
    ...
    for(int i(0); i < 4; ++i){
      ...
      if(!SWIG_IsOK(swig::asval(obj, &temp2[i]))){
...
/*
  ...
  call-seq:
    parse(unsigned int const * buf) -> Ionospheric_UTC_Parameters
...
_wrap_Ionospheric_UTC_Parameters_parse(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    if((!RB_TYPE_P(argv[0], T_ARRAY))
      || (RARRAY_LEN(argv[0]) < sizeof(temp1) / sizeof(temp1[0]))){
      SWIG_exception(SWIG_TypeError, "array is expected, or too short array");
    }
    arg1 = temp1;
    for(int i(0); i < sizeof(temp1) / sizeof(temp1[0]); ++i){
      if(!SWIG_IsOK(SWIG_AsVal_unsigned_SS_int (RARRAY_AREF(argv[0], i), &(arg1[i])))){
...
_wrap_Ephemeris_parse(int argc, VALUE *argv, VALUE self) {
  ...
  {
    if((!RB_TYPE_P(argv[0], T_ARRAY))
      || (RARRAY_LEN(argv[0]) < sizeof(temp2) / sizeof(temp2[0]))){
      SWIG_exception(SWIG_TypeError, "array is expected, or too short array");
    }
    arg2 = temp2;
    for(int i(0); i < sizeof(temp2) / sizeof(temp2[0]); ++i){
      if(!SWIG_IsOK(SWIG_AsVal_unsigned_SS_int (RARRAY_AREF(argv[0], i), &(arg2[i])))){
        SWIG_exception(SWIG_TypeError, "unsigned int is expected");
      }
    }
...
/*
  Document-class: GPS_PVT::GPS::SolverOptions
...
*/
/*
  Document-method: GPS_PVT::GPS::SolverOptions.ionospheric_models
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_ionospheric_models(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::vector< int > result;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > const *","get_ionospheric_models", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  {
    try {
      result = ((GPS_SolverOptions< double > const *)arg1)->get_ionospheric_models();
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_ionospheric_modelse___(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > *","set_ionospheric_models", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  {
    arg2 = &temp2;
...
/*
  Document-method: GPS_PVT::GPS::SolverOptions.elevation_mask=
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_elevation_maske___(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  double *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > *","set_elevation_mask", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  ecode2 = SWIG_AsVal_double(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
  ...
  {
    try {
      result = (double)GPS_SolverOptions_Sl_double_Sg__set_elevation_mask(arg1,(double const &)*arg2);
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_elevation_mask(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > const *","get_elevation_mask", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  {
    try {
      result = (double *) &GPS_SolverOptions_Sl_double_Sg__get_elevation_mask((GPS_SolverOptions< double > const *)arg1);
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
/*
  Document-method: GPS_PVT::GPS::SolverOptions.residual_mask=
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_residual_maske___(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  double *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > *","set_residual_mask", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  ecode2 = SWIG_AsVal_double(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
  ...
  {
    try {
      result = (double)GPS_SolverOptions_Sl_double_Sg__set_residual_mask(arg1,(double const &)*arg2);
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_residual_mask(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > const *","get_residual_mask", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  {
    try {
      result = (double *) &GPS_SolverOptions_Sl_double_Sg__get_residual_mask((GPS_SolverOptions< double > const *)arg1);
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
/*
  Document-method: GPS_PVT::GPS::SolverOptions.f_10_7=
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_f_10_7e___(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  double *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > *","set_f_10_7", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  ecode2 = SWIG_AsVal_double(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
  ...
  {
    try {
      result = (double)GPS_SolverOptions_Sl_double_Sg__set_f_10_7(arg1,(double const &)*arg2);
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
*/
SWIGINTERN VALUE
_wrap_SolverOptions_f_10_7(int argc, VALUE *argv, VALUE self) {
  GPS_SolverOptions< double > *arg1 = (GPS_SolverOptions< double > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double *result = 0 ;
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_GPS_SolverOptionsT_double_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "GPS_SolverOptions< double > const *","get_f_10_7", 1, self )); 
  }
  arg1 = reinterpret_cast< GPS_SolverOptions< double > * >(argp1);
  {
    try {
      result = (double *) &GPS_SolverOptions_Sl_double_Sg__get_f_10_7((GPS_SolverOptions< double > const *)arg1);
    } catch (const native_exception &e) {
      e.regenerate();
      SWIG_fail;
    } catch (const std::exception& e) {
...
static swig_type_info _swigt__p_GPS_TimeT_double_t = {"_p_GPS_TimeT_double_t", "GPS_SpaceNode< double >::gps_time_t *|GPS_Time< GPS_Time< double >::float_t > *|GPS_Time< double > *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_System_ENUT_double_WGS84_t = {"_p_System_ENUT_double_WGS84_t", "System_ENU< double,WGS84 > *|GPS_SpaceNode< double >::enu_t *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_System_LLHT_double_WGS84_t = {"_p_System_LLHT_double_WGS84_t", "GPS_SpaceNode< double >::llh_t *|System_LLH< double,WGS84 > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_System_XYZT_double_WGS84_t = {"_p_System_XYZT_double_WGS84_t", "GPS_SpaceNode< double >::xyz_t *|System_XYZ< double,WGS84 > *", 0, 0, (void*)0, 0};
...
SWIGEXPORT void Init_GPS(void) {
  ...
  SwigClassSolverOptions.klass = rb_define_class_under(mGPS, "SolverOptions", rb_cObject);
  ...
  rb_define_const(SwigClassSolverOptions.klass, "IONOSPHERIC_KLOBUCHAR", SWIG_From_int(static_cast< int >(GPS_SolverOptions< double >::IONOSPHERIC_KLOBUCHAR)));
  rb_define_const(SwigClassSolverOptions.klass, "IONOSPHERIC_NTCM_GL", SWIG_From_int(static_cast< int >(GPS_SolverOptions< double >::IONOSPHERIC_NTCM_GL)));
  rb_define_const(SwigClassSolverOptions.klass, "IONOSPHERIC_NONE", SWIG_From_int(static_cast< int >(GPS_SolverOptions< double >::IONOSPHERIC_NONE)));
  rb_define_const(SwigClassSolverOptions.klass, "IONOSPHERIC_MODELS", SWIG_From_int(static_cast< int >(GPS_SolverOptions< double >::IONOSPHERIC_MODELS)));
  rb_define_const(SwigClassSolverOptions.klass, "IONOSPHERIC_SKIP", SWIG_From_int(static_cast< int >(GPS_SolverOptions< double >::IONOSPHERIC_SKIP)));
  rb_define_method(SwigClassSolverOptions.klass, "ionospheric_models", VALUEFUNC(_wrap_SolverOptions_ionospheric_models), -1);
  rb_define_method(SwigClassSolverOptions.klass, "ionospheric_models=", VALUEFUNC(_wrap_SolverOptions_ionospheric_modelse___), -1);
  rb_define_method(SwigClassSolverOptions.klass, "elevation_mask=", VALUEFUNC(_wrap_SolverOptions_elevation_maske___), -1);
  rb_define_method(SwigClassSolverOptions.klass, "elevation_mask", VALUEFUNC(_wrap_SolverOptions_elevation_mask), -1);
  rb_define_method(SwigClassSolverOptions.klass, "residual_mask=", VALUEFUNC(_wrap_SolverOptions_residual_maske___), -1);
  rb_define_method(SwigClassSolverOptions.klass, "residual_mask", VALUEFUNC(_wrap_SolverOptions_residual_mask), -1);
  rb_define_method(SwigClassSolverOptions.klass, "f_10_7=", VALUEFUNC(_wrap_SolverOptions_f_10_7e___), -1);
  rb_define_method(SwigClassSolverOptions.klass, "f_10_7", VALUEFUNC(_wrap_SolverOptions_f_10_7), -1);
